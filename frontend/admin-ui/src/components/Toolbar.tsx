...
const createButtonClasses =
  "inline-flex items-center gap-2 rounded-lg bg-blue-600 px-3 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-blue-500 disabled:cursor-not-allowed disabled:opacity-60";
...
export function Toolbar({
  ...
  const hasRightArea = hasSearch || hasCreate || Boolean(actions) || Boolean(children);
